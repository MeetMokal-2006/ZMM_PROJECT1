...
@EndUserText.label: 'MM : Interface For Manager Expense Item'
@Metadata.ignorePropagatedAnnotations: true

define view entity ZR_MM_MANAGER_EXPENSEITEM
  as select from zmm_expense_item

  association to parent ZR_MM_MANAGER_EXPENSE as _ExpenseClaim
